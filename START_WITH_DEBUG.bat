@echo off
REM Quick startup guide for Windows with Diagnostics
...
echo   1. Open browser to: http://localhost:3000/audio-upload-debug.html
...
echo   3. Run: .venv\Scripts\python.exe test_audio_upload.py
echo.
