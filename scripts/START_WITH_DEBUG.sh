...
echo "   Command: python -m uvicorn src.api.server:app --reload --port 8000"
...
echo "   - Open: http://localhost:5173/audio-upload-debug.html"
echo "   - Or: file:///d:/Project%20-AI%20audio/frontend/audio-upload-debug.html"
echo "   - Tests: Health Check → Text Analysis → Audio Upload"
echo ""
echo "   Option B - Python Test Suite:"
echo "   Run in terminal 3:"
echo "   cd d:\\Project -AI audio"
echo "   python test_audio_upload.py"
echo ""
